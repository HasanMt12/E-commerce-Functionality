...
const ProductDetails = () => {
    ...
    // Ensure that products or product is not null before accessing its properties
   
    
     console.log(product)
     const [mainImage, setMainImage] = useState(null); // Initialize mainImage state with null
        useEffect(() => {
            if (product && product.images.length > 0) {
                // Set mainImage to the URL of the first image in the product images array
    ...
    const websiteLink = 'https://replicmart.netlify.app'
    return (
        ...
        <div className="lg:block md:block hidden">
            ...
            <div className="flex justify-center items-start gap-3  md:px-2 py-10">
                ...
                {product.images.map((image , index )=>
                     <img key={index} src={image} onClick={() => handleThumbnailClick(image)} className="h-[80px] w-[80px] mb-3 mx-auto object-cover object-center cursor-zoom-in"/>
                )}   
                </div>
                {/* second section */}
                <div className="w-[44%] mr-6" >
                    ...
                    <div className="flex w-full justify-center mt-10 mb-5">
                        <div onClick={handleClick} className={`${currentState === 1 ? "bg-[#526D82] text-white" : "text-[#526D82] "} flex items-center space-x-2 mx-2 border border-[#526D82]  py-4 px-3 cursor-pointer `} >
                            <span>Description</span>
                        </div>

                        <div onClick={handleClick} className={`${currentState === 2 ? "bg-[#526D82] text-white" : "text-[#526D82] "} flex items-center space-x-2 mx-2 border border-[#526D82]  py-4 px-3 cursor-pointer `}>
                ...
                <div className="w-[40%]  font-Roboto px-4">
                    <p className="text-5xl   uppercase">{product.title}</p>
                    ...
                    <div className="flex justify-between  items-start mt-5">
                        ...
                        {/* <button disabled className=' w-[73%] py-[5px] h-12 cursor-not-allowed text-md bg-[#526D82] text-white  gap-2 hover:text-white uppercase shadow-lg hover:shadow-sm'></button> */}
                        ...
                        className="relative inline-flex items-center justify-center md:px-10 px-6 py-1 overflow-hidden font-medium tracking-tighter text-white  bg-[#526D82] rounded-sm group md:py-[10px] w-[75%]">
        ...
        {product &&  (   
         ...
         <div className="flex flex-col justify-start items-start mb-2  mt-2">
                ...
                {product.images.map((image , index )=>
                 <img key={index} src={image} className="h-[54vh] w-full  mx-auto object-cover object-center" alt={product.title} title="click">
                ...
                <div className="px-2 ">
                    ...
                    <h2 className="text-md text-gray-600 leading-none my-1">{product.description}</h2>
                    ...
                    <div className="flex justify-center items-center">
                        ...
                        className="my-2 bg-[#526D82]  h-10 cursor-pointer uppercase  border-[2px]  font-Roboto text-white hover:text-[#526D82] text-md hover:bg-transparent rounded-md border-[#526D82] text-sm  w-full font-semibold mb-2" >
                            add to bag
                        </button>
                    ...
                    <div >
                        <Accordion >
                            <AccordionItem key="1" aria-label="Accordion 1" title="Description">
                                <div className="pb-4 px-6">
                                      {product.description &&  <div className=" text-start text-xs text-gray-700">
