    ...
    <div className="left-0 right-0 inline-block lg:mt-0 md:mt-20 mt-10  lg:px-4 md:px-0 py-2.5  sm:px-0">
      <form onSubmit={handleSubmit(submitHandler)} className="flex flex-col gap-6 pb-4 my-auto" >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="mt-4">
            <h1 className="text-center  text-[#6f7277]">Already have an account? <span onClick={() => handleButtonClick(1)} className="text-[#b89c07] cursor-pointer font-semibold underline mb-5">Log In</span></h1>
          </div>
        </div>
